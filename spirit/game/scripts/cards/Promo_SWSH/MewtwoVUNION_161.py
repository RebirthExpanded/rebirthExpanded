"""Mewtwo V-UNION, bottom-left piece (SWSH Promo 161 -- JP Special Card Set
007/013, the art here).

One of the four Pokemon V-UNION cards. This piece prints Psysplosion [PC];
...
card = VUnionPieceCardDef(
    ...
    guid="bd4f4770-a605-522d-ab26-db012c071b31",
    key="Promo_SWSH",
    name=_UNION.name,
