"""Mewtwo V-UNION, top-right piece (SWSH Promo 160 -- JP Special Card Set
006/013, the art here).

One of the four Pokemon V-UNION cards. This piece prints Super Regeneration [PC];
...
card = VUnionPieceCardDef(
    ...
    position="top-right",
    guid="ff22db30-2197-57a8-b7ad-2207738d8ce8",
    key="Promo_SWSH",
    name=_UNION.name,
