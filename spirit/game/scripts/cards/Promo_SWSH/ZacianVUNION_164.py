"""Zacian V-UNION, top-right piece (SWSH Promo 164 -- JP Special Card Set
010/013, the art here).

One of the four Pokemon V-UNION cards. This piece prints Dance of the Crowned Sword [MMC] 150;
...
card = VUnionPieceCardDef(
    ...
    position="top-right",
    guid="1e973339-871c-508d-adc6-15a0f0d080f5",
    key="Promo_SWSH",
    name=_UNION.name,
